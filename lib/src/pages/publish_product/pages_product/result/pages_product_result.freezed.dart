...
part of 'pages_product_result.dart';
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$PageResultCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'PageResult<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements PageResult<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$PageResultCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'PageResult<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements PageResult<T> {
